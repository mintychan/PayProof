export const CONFIDENTIAL_VESTING_ABI = [
  {
    "inputs": [
      {
    ...
    "outputs": [
      {
        ...
        "internalType": "struct ConfidentialVestingVault.VestingScheduleView",
        "name": "",
        "type": "tuple"
      }
    ],
